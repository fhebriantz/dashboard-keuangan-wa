...
const KEYWORDS: Record<string, string[]> = {
  Makan: ['makan', 'makanan', 'nasi', 'kopi', 'ngopi', 'jajan', 'jajanan', 'sarapan', 'minum', 'minuman', 'snack', 'cemilan', 'camilan', 'gofood', 'grabfood', 'shopeefood', 'warteg', 'warung', 'padang', 'bakso', 'mie', 'mi', 'ayam', 'sate', 'seblak', 'cafe', 'kafe', 'resto', 'restoran', 'nasgor', 'gorengan', 'martabak', 'soto', 'geprek', 'boba', 'teh', 'es', 'roti', 'kue', 'buah', 'sayur', 'lauk', 'catering', 'katering', 'sarabba', 'dimsum', 'sushi', 'pizza', 'burger', 'kfc', 'mcd', 'starbucks', 'ramen', 'pecel', 'gado', 'nasgor', 'jus'],
